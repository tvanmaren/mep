...
These files are the lifted portable-document bundle for the standalone `mep` tool.
...
- **Explicit uncertainty** — known vs volatile is written down, not implied.
- **Checkpoints** — after each slice, replan from what actually shipped.
